...
public class DeleteItemScreenStore extends Application implements Initializable {
    ...
    public void start(Stage primaryStage) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("DeleteItemScreenStore.fxml"));
    ...
    public void selectType(ActionEvent actionEvent) throws IOException {
        try {
            ...
            if(opt.equals("Category")) {
                ...
                selectcategory.getItems().setAll(Database.storeadmin.getStore().getCategories().keySet());
    ...
    public void selectCategory(ActionEvent actionEvent) throws IOException {
        try {
            ...
            selectsubcategory.getItems().setAll(Database.storeadmin.getStore().getCategories().get(opt).getSubcategory().keySet());
        } catch (Exception e) {
        }
    }
    ...
    public void selectSubcategory(ActionEvent actionEvent) throws IOException {
        try {
            ...
            selectitem.getItems().setAll(Database.storeadmin.getStore().getCategories().get(cat).getSubcategory().get(sub).getItems().keySet());
        } catch (Exception e) {
        }
    }
    ...
    public void buttonaction(ActionEvent actionEvent) throws IOException {
        try {
            ...
            if(type.equals("Category")) {
                Database.storeadmin.deleteCategory(cat);
            } else if(type.equals("Subcategory")) {
                String sub = selectsubcategory.getValue().toString();
                Database.storeadmin.deleteSubcategory(cat, sub);
            } else if(type.equals("Item")) {
                String sub = selectsubcategory.getValue().toString();
                String itemname = selectitem.getValue().toString();
                Database.storeadmin.deleteItem(cat, sub, itemname);
            }
        } catch (Exception e) {
        }
